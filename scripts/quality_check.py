...
SUITES = {
    ...
    "conversation": (
        ...
        "test_context_evaluator.py", "test_ollama_context_retention.py",
        "test_conversation_intent_routing.py", "test_conversation_corrections.py",
        "test_acute_safety.py", "test_acute_safety_routing.py",
        "test_identity_status.py",
        "test_capability_discovery.py",
        "test_fantasy_intent_routing.py", "test_fantasy_dashboard_command.py",
        "test_admin_credential_routing.py",
        "test_owner_action_routing.py",
        "test_file_continuation.py",
        "test_generated_file_origin.py",
        "test_workflow_draft_handoff.py",
        "test_odds_arithmetic.py", "test_betting_static.py",
        "test_natural_billing_status.py",
        "test_natural_live_info.py",
        "test_scheduled_post_history.py",
        "test_group_context.py", "test_group_rate_limit.py",
        "test_group_context_budget.py",
        "test_group_speaker_context.py",
        "test_native_command_history.py",
        "test_ufc_delivered_history.py",
        "test_fact_save_receipts.py",
        "test_conversation_personality.py", "test_fast_chat_latency.py", "test_ollama_prompt_routing.py",
        "test_model_routing.py", "test_capability_gap_safety.py", "test_actor_capability_context.py",
        "test_unexecuted_action_truth.py",
        "test_terminal_lookup_results.py",
    ),
    "images": (
    ...
    "schedules": (
        ...
        "test_reminder_edits.py",
        "test_cron_draft_cancellation.py",
        "test_cron_cancel_intent_boundary.py",
        "test_group_control_intent.py",
        "test_cron_clarification_delivery.py",
        "test_workflow_draft_handoff.py",
        "test_reminder_send_failures.py", "test_scheduler_retry.py", "test_cron_occurrences.py",
        "test_scheduled_post_history.py",
        "test_scheduled_command_permissions.py", "test_cron_creation_permissions.py",
        "test_group_cron_creation_permissions.py", "test_research_cron_drafts.py",
        "test_research_evidence.py",
    ),
    "access": (
        "test_access_safety.py", "test_permissions_safety.py", "test_private_send.py",
        "test_group_owner_presence.py",
