...
class OpenAIImageRoutingTests(unittest.TestCase):
    ...
    def test_approved_friend_dm_routes_explicit_image_scan(self):
        ...
        handler = _load_main_function("_handle_friend_dm", {
            # Full handler safety behavior is covered in test_acute_safety_routing;
            # this AST-isolated fixture concerns an unrelated screenshot request.
            "_handle_acute_safety": lambda *args, **kwargs: False,
            "_handle_identity_status": lambda *args, **kwargs: False,
