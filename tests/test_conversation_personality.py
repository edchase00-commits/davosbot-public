...
class ConversationPersonalityTests(unittest.TestCase):
    ...
    def test_literal_food_and_file_requests_do_not_inject_roast_mode(self):
        for text in (
            ...
            "how long should I roast salmon?", "roast frozen broccoli at 400 degrees",
            "cook a whole fish", "roast these brussels sprouts",
    ...
    def test_declined_roast_or_serious_request_is_not_forced_into_roast_mode(self):
        for text in (
            "don't roast me, just give me your take", "no jokes, roast chicken for how long?",
            "stop roasting me", "please don\u2019t roast me, just explain the mistake",
