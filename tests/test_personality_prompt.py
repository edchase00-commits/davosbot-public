    ...
    def test_message_relevant_memory_is_promoted_before_bulk_facts(self):
        with TemporaryDirectory() as tmp:
            ...
            with (
                ...
                patch.object(personality, "is_owner", return_value=True),
            ):
                prompt = personality.build_system_prompt(
                    user_text="what happened to Decatur behavior?",
                    sender="+15550000001", chat_id="+15550000001", is_group=False,
                )
    ...
    def test_stale_model_memory_fact_is_suppressed(self):
        with TemporaryDirectory() as tmp:
            ...
            with (
                ...
                prompt = personality.build_system_prompt(
                    user_text="what models do you use?",
                    sender="+15550000001", chat_id="+15550000001", is_group=False,
                )
